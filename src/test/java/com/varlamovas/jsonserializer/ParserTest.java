...
class ParserTest {
    ...
    void parseCommaSeparated() {
        ...
        Seed<CustomClassForSimpleParserTest> seed = new Seed<>(CustomClassForSimpleParserTest.class);
        Parser<CustomClassForSimpleParserTest> parser = new Parser<>(stringReader, seed);
